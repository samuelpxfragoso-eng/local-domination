...
import { Globe, ArrowRight, CheckCircle2, Layout, Instagram, Search, Star, Zap, User, Check, Medal, Zap as Fast, Share2 } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start justify-items-center">
            ...
            <div className="flex flex-col items-center gap-6 group">
              <div className="w-[280px] h-[580px] bg-white rounded-[45px] overflow-hidden shadow-2xl relative border-[8px] border-slate-900 group-hover:scale-[1.02] transition-transform duration-500 bg-black">
                <video autoPlay loop muted playsInline className="w-full h-full object-cover">
                  <source src="https://bvubljssahqtzzeboeew.supabase.co/storage/v1/object/public/our/site%20lavanderia.mp4" type="video/mp4" />
                </video>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-6 group">
              <div className="w-[280px] h-[580px] bg-white rounded-[45px] overflow-hidden shadow-2xl relative border-[8px] border-slate-900 group-hover:scale-[1.02] transition-transform duration-500 bg-black">
                <video autoPlay loop muted playsInline className="w-full h-full object-cover">
                  <source src="https://bvubljssahqtzzeboeew.supabase.co/storage/v1/object/public/our/site%20patel.mp4" type="video/mp4" />
                </video>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-6 group">
              <div className="w-[280px] h-[580px] bg-white rounded-[45px] overflow-hidden shadow-2xl relative border-[8px] border-slate-900 group-hover:scale-[1.02] transition-transform duration-500 bg-black">
                <video autoPlay loop muted playsInline className="w-full h-full object-cover">
                  <source src="https://bvubljssahqtzzeboeew.supabase.co/storage/v1/object/public/our/site%20siao%20barber.mp4" type="video/mp4" />
                </video>
              </div>
            </div>
          </div>
      ...
      {/* Lab Showcase Section - Side by Side Videos */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="relative aspect-video rounded-3xl overflow-hidden glass border-white/5 group">
              <video autoPlay loop muted playsInline className="w-full h-full object-cover grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700">
                <source src="https://bvubljssahqtzzeboeew.supabase.co/storage/v1/object/public/our/grok-video-b07b3f8c-68f8-49c0-bf15-87645e6c3248.mp4" type="video/mp4" />
              </video>
            ...
            <div className="relative aspect-video rounded-3xl overflow-hidden glass border-white/5 group">
              <video autoPlay loop muted playsInline className="w-full h-full object-cover grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700">
                <source src="https://bvubljssahqtzzeboeew.supabase.co/storage/v1/object/public/our/grok%20site.mp4" type="video/mp4" />
              </video>
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent pointer-events-none" />
            </div>
            ...
            <div className="relative aspect-video rounded-3xl overflow-hidden glass border-white/5 group">
              <video autoPlay loop muted playsInline className="w-full h-full object-cover grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700">
                <source src="https://bvubljssahqtzzeboeew.supabase.co/storage/v1/object/public/our/grok%20lsa%201.mp4" type="video/mp4" />
              </video>
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent pointer-events-none" />
            </div>
          </div>
              ...
              <div className="w-full max-w-md bg-[#161c27] p-10 md:p-14 rounded-2xl border border-gold/30 shadow-[0_0_60px_rgba(251,191,36,0.05)] relative overflow-hidden group">
                ...
                <div className="relative z-10 text-center">
                  <div className="flex justify-center mb-8">
                    <Fast size={50} className="text-gold" />
                  </div>
                  <h3 className="text-3xl font-black text-white mb-1 uppercase tracking-tight">
                    {t.digitalStructure.card.title}
                  </h3>
                  <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.3em] mb-12">
                    {t.digitalStructure.card.subtitle}
                  </p>
                  <div className="mb-12">
                    <span className="text-gray-500 line-through text-lg block mb-2">
                      {t.digitalStructure.card.originalPrice}
                    </span>
                    <span className="text-6xl md:text-7xl font-black text-gold">
                      {t.digitalStructure.card.currentPrice}
                    </span>
                    <p className="text-gray-500 text-xs font-bold uppercase mt-2 tracking-widest">
                      {t.digitalStructure.card.footnote}
                    </p>
                  </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {pricingData.map((plan) => (
              <div key={plan.id} className={`relative bg-[#161c27] p-8 rounded-2xl flex flex-col border transition-all duration-500 ${plan.popular ? 'border-gold shadow-[0_0_40px_rgba(251,191,36,0.15)] scale-[1.02] z-10' : 'border-white/5 hover:border-white/10'}`}>
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-transparent text-gold px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest whitespace-nowrap">MAIS POPULAR</div>
                )}
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 lg:gap-16">
          <div className="w-full md:w-5/12 relative">
            <div className="aspect-square glass rounded-[40px] overflow-hidden border border-white/10 shadow-2xl">
              <img 
                src="https://bvubljssahqtzzeboeew.supabase.co/storage/v1/object/public/our/WhatsApp%20Image%202026-02-10%20at%203.51.10%20PM.jpeg" 
                alt="Samuel Fragoso" 
